...
async function main() {
  ...
  // Try without specifying gas and let ethers estimate
  // The key: we need to set maxFeePerGas appropriately
  // Safe pays gas from its balance
  // 0.000628 ETH at 2 gwei = enough for 314,000 gas
  
  const receipt = await safe.execTransaction(
    NEW_ORACLE, "0", addStakingData, 0,
    0, // safeTxGas - let it use whatever
    0, // baseGas  
    0, // gasPrice - use network price
