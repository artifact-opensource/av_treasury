...
async function main() {
  ...
  const FACTORY = "0x33128a8fC17869897dcE68Ed026d694621f6FDfD"; // Correct Base V3 Factory
  ...
  console.log("=== Uniswap V3 Pools on Base ===");
  for (const fee of [100, 500, 3000, 10000]) {
    for (const [label, a, b] of [["AU/WETH", AU, WETH], ["AG/WETH", AG, WETH], ["AU/AG", AU, AG], ["WETH/AU", WETH, AU], ["WETH/AG", WETH, AG]]) {
      try {
